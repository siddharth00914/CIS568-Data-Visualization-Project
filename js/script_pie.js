class PieChart {
    ...
    initChart() {
        ...
        this.updateChart = function(year) {
            const yearData = this.data.map(d => ({
                key: d.key,
                value: (d.values.find(v => v.key === year) || {}).value || 0
            }));
        ...
        this.updateChart(this.activeYear); // Initial update
    }
...
document.addEventListener('DOMContentLoaded', () => {
    const data = [{"key":"GBR","values":[{"key":"1980","value":"47"},{"key":"1984","value":"118"},{"key":"1988","value":"172"},{"key":"1992","value":"222"},{"key":"1996","value":"248"},{"key":"2000","value":"302"},{"key":"2004","value":"359"},{"key":"2008","value":"440"},{"key":"2012","value":"566"},{"key":"2016","value":"711"}]},
    ...
    slider.addEventListener('input', function() {
        pieChart.updateYear(this.value);
    });
